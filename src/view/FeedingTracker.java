 ...
 * @author diya
 */
public class FeedingTracker extends javax.swing.JFrame {
    private int appuserPk = 0;
    private Object ConnectionProvider;
    /**
     * Creates new form FeedingTracker
     */
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(136, 58, 53));
        ...
        jLabel1.setText("Pet Feeding Tracker");
        ...
        userTabel.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jLabel4.setText("Amount ( Cups or Gm)");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
       ...
       try{
           ...
           Resultset rs = (Resultset) st.executeQuery("select * from appuser where userRole='Admin'");
            while(rs.next()){
                model.addRow(new Object[]{rs.getString("appuser")});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FeedingTracker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FeedingTracker().setVisible(true);
            }
        });
    }
