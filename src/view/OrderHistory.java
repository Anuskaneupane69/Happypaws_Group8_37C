...
public class OrderHistory extends javax.swing.JFrame {
    ...
    public OrderHistory() {
        ...
        SidePanel.setPreferredSize(new Dimension(273,153));
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/Screenshot 2025-05-29 004840.png"))); // NOI18N
        ...
        jPanel3.setBackground(new java.awt.Color(239, 235, 235));

        SidePanel.setBackground(new java.awt.Color(255, 199, 147));

        reviewarea.setColumns(20);
        reviewarea.setRows(5);
        Review.setViewportView(reviewarea);
        ...
        SidePanelLayout.setVerticalGroup(
            ...
            .addGroup(SidePanelLayout.createSequentialGroup()
                .addGap(40, 40, 40)
                .addComponent(Review, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(27, 27, 27)
                .addComponent(jButton1)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/Screenshot 2025-06-25 103825.png"))); // NOI18N
        ...
        jLabel4.setText("Pet Hair Remover");
    ...
    private void REVIEWActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_REVIEWActionPerformed
        ...
        System.out.println("mkwenfkl");
        SidePanel.setVisible(true);   // Ensure parent is visible
        Review.setVisible(true);      // Show scroll pane
        reviewarea.setVisible(true);  // Show text area
